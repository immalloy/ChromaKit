...
ChromaKit takes a folder of numbered WAV samples and generates:
...
2. Name the samples `1.wav`, `2.wav`, `3.wav`, and so on.
3. Open ChromaKit.
4. Choose the sample folder.
5. Pick the starting note, octave, range, and gap.
